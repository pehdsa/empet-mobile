...
import { useMyLostPets } from "@/hooks/useMyLostPets";
import { NavHeader } from "@/components/ui/NavHeader";
import { Skeleton } from "@/components/ui/Skeleton";
import { LostPetCard } from "@/components/menu/LostPetCard";

export default function MyLostPetsScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
      <View style={{ paddingTop: insets.top }} className="bg-background">
        <NavHeader title="Meus Pets Perdidos" className="px-6" />
      </View>
